...
export const ENLACES_NO_AUTORIZADOS: readonly EnlaceNoAutorizado[] = [
  { dominio: 'buybacklinks.agency', dr: 70, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'fiverr-seo-for-small-businesses.site', dr: 68, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'seogrow.agency', dr: 67, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'rankgrowth.agency', dr: 66, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'seonix.agency', dr: 65, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'rank-top.click', dr: 59, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'rankio.agency', dr: 59, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'linkrankpro.shop', dr: 54, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'rankxlinks.shop', dr: 54, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'ranklinkerpro.shop', dr: 54, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'buyseobacklinks.shop', dr: 54, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'rankboostly.shop', dr: 54, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'authoritybacklinks.shop', dr: 54, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'pbnseolinks.shop', dr: 53, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'ranklinkx.shop', dr: 53, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'linkrankboost.shop', dr: 53, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'seolinkpro.shop', dr: 53, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'linkseopro.shop', dr: 53, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'ranklinkpro.shop', dr: 53, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'premiumseolinks.shop', dr: 53, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'toplinkranker.shop', dr: 53, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'rank-now.website', dr: 51, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'linkspro.agency', dr: 49, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'backlinkshop.site', dr: 48, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'trafficspike.shop', dr: 47, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'seodaro.com', dr: 42, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'byteshort.xyz', dr: 41, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'seo-high-ranking.shop', dr: 41, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'atomizelink.icu', dr: 40, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'kawaiishop.shop', dr: 33, detectado: '2026-08-18', tipo: 'enlace-spam' },
  { dominio: 'thebacklink.shop', dr: 33, detectado: '2026-08-18', tipo: 'enlace-spam' },
  {
