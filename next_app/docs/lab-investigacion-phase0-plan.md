...
| D10 | Base jurídica **propuesta (provisional)**: interés legítimo (art. 6.1.f RGPD) sobre datos seudonimizados con transparencia previa. El laboratorio nace como herramienta integrada en un proyecto de investigación y la aportación de resultados estadísticos forma parte de su diseño y de sus condiciones de funcionamiento, explicadas de forma transparente al usuario | Consentimiento con casilla | El prompt pide no usar casilla si no es necesaria; se documenta en la LIA (borrador v2) con prudencia y sin cerrar la valoración. Cuestión principal a validar profesionalmente: la obligatoriedad de la aportación cuando el informe individual puede generarse sin ella. **← a validar profesionalmente** |
