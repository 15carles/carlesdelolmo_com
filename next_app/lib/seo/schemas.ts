...
export function generateAuditOfferSchema(
  ...
  const graph: Record<string, unknown>[] = [
    ...
    BUSINESS_SCHEMA,
    {
      ...
      "@id": `${url}#webpage`,
      "url": url,
      "name": "Auditoría SEO + GEO Gratuita | Carles del Olmo",
      "description": "Análisis profesional de tu web, visibilidad en Google y presencia en motores de IA (GEO). Servicio valorado en +750€, disponible gratis para un número limitado de webs cada mes.",
      "inLanguage": "es-ES",
      "isPartOf": { "@id": `${SITE_URL}/#website` },
    ...
    ], breadcrumbId),
    {
      ...
      "description": "Análisis completo de SEO técnico y visibilidad en motores generativos (ChatGPT, Gemini, Perplexity). Promoción limitada a un número de plazas mensual.",
      "provider": { "@id": `${SITE_URL}/#business` },
      "offers": {
        "@type": "Offer",
        "price": "0",
