  ...
  return (
    ...
    >
      ...
      <section aria-labelledby="finalidad-del-tratamiento">
        <h2 id="finalidad-del-tratamiento">3. Finalidad del tratamiento</h2>
      ...
      <section aria-labelledby="base-juridica-del-tratamiento">
        <h2 id="base-juridica-del-tratamiento">4. Base jurídica del tratamiento</h2>
      ...
      <section aria-labelledby="conservacion-de-los-datos">
        <h2 id="conservacion-de-los-datos">5. Conservación de los datos</h2>
      ...
      <section aria-labelledby="destinatarios-y-proveedores">
        <h2 id="destinatarios-y-proveedores">6. Destinatarios y proveedores de servicio</h2>
        ...
        <ul>
          ...
          <li>Supabase (región UE): almacenamiento de datos del formulario</li>
      ...
      <section aria-labelledby="automatizacion-de-procesos">
        <h2 id="automatizacion-de-procesos">7. Automatización de procesos</h2>
      ...
      <section aria-labelledby="decisiones-automatizadas-y-perfilado">
        <h2 id="decisiones-automatizadas-y-perfilado">8. Decisiones automatizadas y perfilado</h2>
        <p>Actualmente no se aplican decisiones automatizadas con efectos jurídicos.</p>
      ...
      <section aria-labelledby="derechos-del-usuario">
        <h2 id="derechos-del-usuario">10. Derechos del usuario</h2>
      ...
      <section aria-labelledby="menores-de-edad">
        <h2 id="menores-de-edad">12. Menores de edad</h2>
      ...
      <section aria-labelledby="seguridad">
        <h2 id="seguridad">13. Seguridad</h2>
      ...
      <section aria-labelledby="cambios-politica-privacidad">
        <h2 id="cambios-politica-privacidad">14. Cambios en la política de privacidad</h2>
