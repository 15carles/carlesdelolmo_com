...
const STATIC_ROUTES: Array<{
  ...
  { path: '/blog/categoria/geo-y-visibilidad-en-ia', changeFrequency: 'weekly', priority: 0.6 },
  { path: '/blog/categoria/diseno-y-desarrollo-web', changeFrequency: 'weekly', priority: 0.6 },
  { path: '/blog/categoria/diseno-web-local', changeFrequency: 'weekly', priority: 0.6 },
  { path: '/blog/categoria/mantenimiento-y-mejora-web', changeFrequency: 'weekly', priority: 0.6 },
