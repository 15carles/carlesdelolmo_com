  ...
  return {
    ...
    icons: {
      icon: [
        ...
        // SVG con el trazado simplificado (sin venas interiores). Los navegadores
        // que lo soportan lo prefieren a cualquier tamaño, incluido el de pestaña,
        // donde el trazado completo se empasta. El isotipo completo vive en
        // /assets/images/logo-isotipo.svg para usos grandes (navbar, OG).
